                ...
                if (typeof data.items !== 'undefined') {
                    ...
                    $.each(data.items, function (key, value) {
                        ...
                        top_stories_html = top_stories_html.concat(`
                            <li class="list-group-item px-1" onclick="javascript:update_article('${value.mainItemLink}')" style="cursor: pointer;">
                            <i class="bi bi-link-45deg"></i><strong>${value.mainItemSource.value}</strong><br>
...
$('#a_domain_news').on('click', function (e) {
    e.preventDefault();
    $("#article_list").html(domain_news_html);    
});
            ...
            success: function (data) {
                ...
                if (typeof data.articles !== 'undefined') {
                    ...
                    $.each(newArray, function (key, value) {
                        ...
                        let mo = new Intl.DateTimeFormat('en', { month: 'short' }).format(d);
                        let da = new Intl.DateTimeFormat('en', { day: '2-digit' }).format(d);
                        domain_news_html = domain_news_html.concat(`                        
                        <li class="list-group-item px-1" onclick="javascript:update_article('${value.url}')" style="cursor: pointer;">
                        <i class="bi bi-link-45deg"></i><strong>${value.domain}</strong><br>
                        ${value.title.slice(0,100)}
                        </li>
